...
`r if(nrow(recent_cases) > 0) paste0("There are ", nrow(recent_cases), " public facilities in Victoria that have been attended by two or more cryptosporidiosis cases with symptom onsets within the past 42 days.")`
