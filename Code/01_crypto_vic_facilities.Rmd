...
version_details: "v1.2, 14/05/2025"
output: 
  html_document: 
    code_folding: none
    toc: true
...
```{r, echo = FALSE}
# Change log
# v1.2: Added troubleshooting for superfluous commas in exposure site names/suburbs
# v1.1: Addition of Victorian and LPHU text summaries and epicurves; addition of 
#       scroll box for public facilities tables; removed interstate facility-level analyses
# v1.0: First version
```
